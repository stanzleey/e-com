...
@include('layouts.hero')
    ...
    {{-- Why Us --}}
    <section class="bbcontainer mx-auto mt-8 px-4 text-center">
        <h2 class="text-2xl font-bold">Kenapa Harus Belanja Disini?</h2>
        <div class="flex justify-center">
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mt-6">
                <div class="bg-blue-900 p-8 rounded-lg shadow flex flex-col items-center text-white w-48 h-48">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V9a1 1 0 011-1h5.5M15 8l3.5 3.5M8 17h10M19 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM5 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
                    </svg>
                    <h3 class="mt-4 text-lg font-bold">Fast Delivery</h3>
                    <p class="text-sm text-center">Pengiriman cepat dan tepat waktu langsung ke rumah Anda.</p>
                </div>
                ...
                <div class="bg-blue-900 p-8 rounded-lg shadow flex flex-col items-center text-white w-48 h-48">
                    ...
                    <h3 class="mt-4 text-lg font-bold">Murah</h3>
                    <p class="text-sm text-center">Harga terbaik dengan promo menarik untuk semua produk.</p>
                </div>
                ...
                <div class="bg-blue-900 p-8 rounded-lg shadow flex flex-col items-center text-white w-48 h-48">
                    ...
                    <h3 class="mt-4 text-lg font-bold">Berkualitas</h3>
                    <p class="text-sm text-center">Produk terbaik dengan jaminan kualitas yang terpercaya.</p>
                </div>
            </div>
        </div>
    </section>
